...
import { ReservedSeats } from '../../store/action/eventAction'
...
class Buy extends Component {
    ...
    componentWillReceiveProps(props) {
        ...
        if (props.reservedSeats) {
            this.setState({ reservedSeats: props.reservedSeats })
        }
    }
...
function mapStateToProps(state) {
    return ({
        ...
        list: state.eventsReducer.LIST,
        event: state.eventsReducer.EVENTS,
        reservedSeats: state.eventsReducer.RESERVEDSEATS,
    })
}
